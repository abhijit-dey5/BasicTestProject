...
Puppet::Type.newtype(:gauth_credential) do
  ...
  feature :defaultuserapplication,
          "Authenticate using user's default application credential"
  feature :machineaccount, "Authenticate using the machine's account"

  newparam :title, namevar: true
  newparam :path, feature: :serviceaccount
  newparam :scopes, feature: :serviceaccount
  newparam :account_id, feature: :machineaccount
